...
**LeaderWorkerSet-VLLM Deployments** (`framework: lwsVllm`):
...
| `inference.framework`                                                    | Framework type to use (vllm, rayVllm, or lwsVllm) | `vllm`                                                                      |
...
inference:
  ...
  framework: vllm   # vllm, rayVllm, or lwsVllm
